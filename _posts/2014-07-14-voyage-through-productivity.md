...
I can’t remember how exactly, but for some reason I started reading lifehack.org everyday. The site was far from famous or revolutionary, but I decided that it contained almost all of the important knowledge amassed by mankind to date. After reading my bajillionth post paraphrasing Getting Things Done by <a href="http://en.wikipedia.org/wiki/Getting_Things_Done" target="_blank">David Allen</a>, I finally forked out seven of my English pounds for my very own copy of the source material. I read it.
...
(Tune in next week when I should have finished my writeup of my current organisational approach. The draft so far is obviously groundbreaking, but its ever-increasing length does make it hard to claim that the system is all driven by simplicity and freedom. This will of course not stop me from trying.)
